...
CREATE TABLE dbo.T_Playlist_Quality (
	Id uniqueidentifier DEFAULT newid() NOT NULL,
	PlaylistMovieId uniqueidentifier NOT NULL,
	QualityId INT NOT NULL,
	MovieUrl VARCHAR(500) NOT NULL,
	CreatedDateUTC datetime CONSTRAINT DF_T_Playlist_Quality_CreatedDateUTC DEFAULT getutcdate() NOT NULL,
	CONSTRAINT T_Playlist_Quality_Id PRIMARY KEY CLUSTERED
	(
		Id ASC
	)
);
...
ALTER TABLE dbo.T_Playlist_Quality 
ADD CONSTRAINT FK_T_Playlist_Quality_PlaylistMovieId_To_T_Playlist_Movie_Id 
